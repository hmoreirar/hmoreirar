...
I enjoy mixing design, code and fast iteration — from e-commerce and SaaS to AI tools, scrapers and ESP32 projects.

---

## Tech Stack

**Frontend:** React · Next.js · Astro · Tailwind · GSAP  
**Backend:** Node.js · Express · PostgreSQL · Supabase  
**Tools:** Git · Linux · Docker · Figma  
**Exploring:** Machine Learning · Elasticsearch · ESP32 · Automation
...
- Experimenting with ESP32 + IoT systems
- Improving UI motion and interactions with GSAP
